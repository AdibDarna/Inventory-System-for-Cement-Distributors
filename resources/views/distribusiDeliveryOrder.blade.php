...
<head>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.6.3/js/bootstrap.min.js"></script>
...
<body class="g-sidenav-show  bg-gray-100">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            <ul class="navbar-nav" style="margin-left:15px">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  active" href="/distribusideliveryorder">
                                        <div
                                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                            <img class="icon icon-sm"
                                                src="{{ asset('assets/images/svg/delivery.svg') }}" />
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Delivery Order</h6>
                </nav>
        ...
        <div class="container-fluid py-4">
            <form action="/distribusideliveryorder/cari" method="GET">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <button type="button" onclick="openTambahSemen()"
                        ...
                        data-target="#modalTambahSemen">Tambah Data Delivery</button>
                </div>
                ...
                <div class="modal fade" id="modalTambahSemen" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="/tambahdatado" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalTambahMobilTitle">Tambah Data Delivery</h5>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 mb-2">
                                            <input class="form-control" type="text" placeholder="Kode DO"
                                                name="kode_do" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 m-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 mb-2" id="selectAgen">
                                            <select class="form-control" id="agenSelect" data-width="100%"
                                                placeholder="Ship To" name="ship_to" required>
                                                <option disabled selected>Ship To</option>
                                                @foreach ($agen as $ag)
                                                    <option value="{{ $ag->kode_agen }}">{{ $ag->nama_agen }} -
                                                        {{ $ag->nama_toko }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 mb-2" id="selectMobil">
                                            <select class="form-control" id="mobilSelect"data-width="100%"
                                                placeholder="Mobil" name="mobil" required>
                                            ...
                                            <select class="form-control" id="supirSelect" data-width="100%"
                                                ...
                                                @foreach ($supir as $sup)
                                                    @if (collect($checkStatus)->contains('kode_supir', $sup->kode_supir) &&
                                                            collect($checkStatus)->contains('status', 'Proses'))
                                                    @else
                                                        <option value="{{ $sup->kode_supir }}">{{ $sup->nama_supir }}
                                                            - {{ $sup->no_hp }}
                                                        </option>
                                                    @endif
                                                @endforeach
                    ...
                    function totals() {
                        ...
                        @foreach ($semen as $se)
                            if ('{{ $se->id_semen }}' == semen.value) {
                                ...
                                tot.value = {{ $se->harga_jual }} * qty.value;
                            }
                ...
                <div class="modal fade" id="modalExport" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="/deliveryorder/import_excel" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-header">
                ...
                {{-- ----------------------------------------------------------------Modal turncate/hapus semua data ----------------------------------------------------------------- --}}
                @if (Auth::user()->status == 'admin')
                    <div class="col-sm-2">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="closeModalTrunk()"
                                        class="btn btn-secondary">Close</button>
                                    <a href="/deliveryorder/truncate" class="btn btn-warning">Truncate</a>
                                </div>
                ...
                {{-- ---------------------------------------------------------------- Tutup Modal turncate/hapus semua data ----------------------------------------------------------------- --}}
                ...
                <div class="col-sm-1">
                    ...
                    <form action="/deliveryorder/preview_print" method="POST">
                        @csrf
                        <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                                            ...
                                            <td>
                                                <div class="row align-item-centered">
                                                    <div class="col-sm-3 m-1">
                                                        <div class="col-sm-2">
                                                            <button type="button"
                                                                onclick="openEdit{{ $s->kode_do . 'edit' }}()"
                                                                class="btn p-2 bg-gradient-warning m-0"
                                                                data-toggle="modal"
                                                                data-target="#modalEdit{{ $s->kode_do . 'edit' }}"><img
                                                                    class="icon icon-xxs"
                                                        ...
                                                        <div class="modal fade"
                                                            id="modalEdit{{ $s->kode_do . 'edit' }}" tabindex="-1"
                                                            role="dialog"
                                                            aria-labelledby="modalEditTitle{{ $s->kode_do . 'edit' }}"
                                                            aria-hidden="true">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="modalHapusTitle{{ $s->kode_do . 'edit' }}">
                                                                            Edit Data {{ $s->kode_do }}</h5>

                                                                    </div>
                                                                    <form action="/editdatado" method="POST"
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12 mb-2"
                                                                                    id="selectAgen{{ $s->kode_do . 'edit' }}">
                                                                                    <select class="form-control"
                                                                                        id="agenSelect{{ $s->kode_do . 'edit' }}"
                                                                                        data-width="100%"
                                                                                        placeholder="Ship To"
                                                                                        name="ship_to" required>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12 mb-2">
                                                                                    <input class="form-control"
                                                                                        value="{{ $s->qty }}"
                                                                                        onkeyup="totals{{ $s->kode_do . 'edit' }}()"
                                                                                        id="qty{{ $s->kode_do . 'edit' }}"
                                                                                        type="number"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12 mb-2"
                                                                                    id="selectSemen{{ $s->kode_do . 'edit' }}">
                                                                                    <select class="form-control"
                                                                                        id="semen{{ $s->kode_do . 'edit' }}"
                                                                                        data-width="100%"
                                                                                        onchange="totals{{ $s->kode_do . 'edit' }}()"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12 mb-2"
                                                                                    ...
                                                                                    <label class="input-cur-label"
                                                                                        for="tot{{ $s->kode_do . 'edit' }}">
                                                                                        Rp. <span
                                                                                            id="formatTotal{{ $s->kode_do . 'edit' }}">{{ number_format($s->total_harga) }}</span>
                                                                                    </label>
                                                                                    <input class="form-control"
                                                                                        id="tot{{ $s->kode_do . 'edit' }}"
                                                                                        type="text"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12 mb-2"
                                                                                    id="selectMobil{{ $s->kode_do . 'edit' }}">
                                                                                    <select class="form-control"
                                                                                        id="mobilSelect{{ $s->kode_do . 'edit' }}"
                                                                                        data-width="100%"
                                                                                        placeholder="Mobil"
                                                                                        name="mobil" required>
                                                                                        <option
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12 mb-2"
                                                                                    id="selectSupir{{ $s->kode_do . 'edit' }}">
                                                                                    <select class="form-control"
                                                                                        id="supirSelect{{ $s->kode_do . 'edit' }}"
                                                                                        data-width="100%"
                                                                                        placeholder="Supir"
                                                                                        name="supir" required>
                                                                                        <option
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12 mb-2"
                                                                                    ...
                                                                                    <label class="input-cur-label"
                                                                                        ...
                                                                                        Rp. <span
                                                                                            id="biayaformat{{ $s->kode_do . 'edit' }}">{{ number_format($s->biaya_pemesanan) }}
                                                                                        </span>
                                                                                    </label>
                                                                                    <input class="form-control"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12 mb-2">
                                                                                    <select class="form-control"
                                                                                        id="debit{{ $s->kode_do . 'edit' }}"
                                                                                        onchange="showDebit{{ $s->kode_do . 'edit' }}()"
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                                                onclick="closeEdit{{ $s->kode_do . 'edit' }}()"
                                                                                class="btn btn-secondary">Close</button>
                                                                            <button type="submit"
                                                        ...
                                                        <script>
                                                            $(document).ready(function() {
                                                                $("#mobilSelect{{ $s->kode_do . 'edit' }}").select2({
                                                                    dropdownParent: $("#selectMobil{{ $s->kode_do . 'edit' }}")
                                                                });
                                                                $("#semen{{ $s->kode_do . 'edit' }}").select2({
                                                                    dropdownParent: $("#selectSemen{{ $s->kode_do . 'edit' }}")
                                                                });
                                                                $("#supirSelect{{ $s->kode_do . 'edit' }}").select2({
                                                                    dropdownParent: $("#selectSupir{{ $s->kode_do . 'edit' }}")
                                                                });
                                                                $("#agenSelect{{ $s->kode_do . 'edit' }}").select2({
                                                                    dropdownParent: $("#selectAgen{{ $s->kode_do . 'edit' }}")
                                                                });


                                                            });

                                                            function showDebit{{ $s->kode_do . 'edit' }}() {
                                                                var kondisi{{ $s->kode_do . 'edit' }} = document.getElementById("debit{{ $s->kode_do . 'edit' }}").value;
                                                                var debit{{ $s->kode_do . 'edit' }} = document.getElementById("cash{{ $s->kode_do . 'edit' }}");
                                                                if (kondisi{{ $s->kode_do . 'edit' }} == 'Debit') {
                                                                    debit{{ $s->kode_do . 'edit' }}.classList.add("d-block");
                                                                    debit{{ $s->kode_do . 'edit' }}.classList.remove("d-none");
                                                                } else {
                                                                    debit{{ $s->kode_do . 'edit' }}.classList.add("d-none");
                                                                    debit{{ $s->kode_do . 'edit' }}.classList.remove("d-block");
                                                                }
                                                            }
                                                            ...
                                                            function totals{{ $s->kode_do . 'edit' }}() {
                                                                var spanTotal{{ $s->kode_do . 'edit' }} = document.getElementById('formatTotal{{ $s->kode_do . 'edit' }}');
                                                                var semen{{ $s->kode_do . 'edit' }} = document.getElementById("semen{{ $s->kode_do . 'edit' }}");
                                                                var qty{{ $s->kode_do . 'edit' }} = document.getElementById("qty{{ $s->kode_do . 'edit' }}");
                                                                var tot{{ $s->kode_do . 'edit' }} = document.getElementById("tot{{ $s->kode_do . 'edit' }}");
                                                                var harga = null;
                                                                @foreach ($semen as $se)
                                                                    if ('{{ $se->merek_semen }}' == semen{{ $s->kode_do . 'edit' }}.value) {

                                                                        tot{{ $s->kode_do . 'edit' }}.value = {{ $se->harga_jual }} * qty{{ $s->kode_do . 'edit' }}.value;
                                                                    }
                                                                    spanTotal{{ $s->kode_do . 'edit' }}.innerHTML = tot{{ $s->kode_do . 'edit' }}.value.replace(
                                                                        /\B(?=(\d{3})+(?!\d))/g, ',');
                                                                @endforeach
                                                        ...
                                                        <script>
                                                            function openEdit{{ $s->kode_do . 'edit' }}() {
                                                                $('#modalEdit{{ $s->kode_do . 'edit' }}').modal('toggle');
                                                            }

                                                            function closeEdit{{ $s->kode_do . 'edit' }}() {
                                                                $('#modalEdit{{ $s->kode_do . 'edit' }}').modal('toggle');
                                                                $('#modalEdit{{ $s->kode_do . 'edit' }}').modal('dispose');
                                                                $('.modal-backdrop').remove();
                                                            }
                                                        </script>
                                                    </div>
                                                    ...
                                                    @if (Auth::user()->status == 'admin')
                                                        <div class="col">
                                                            <div class="col-sm-2 m-1">
                                                                <button type="button"
                                                                    onclick="openHapus{{ $s->kode_do }}()"
                                                                    class="btn p-2 bg-gradient-danger m-0"
                                                                    data-toggle="modal"
                                                                    data-target="#modalHapus{{ $s->kode_do }}"><img
                                                                        class="icon icon-xxs"
                                                            ...
                                                            <div class="modal fade"
                                                                id="modalHapus{{ $s->kode_do }}" tabindex="-1"
                                                                role="dialog"
                                                                aria-labelledby="modalHapusTitle{{ $s->kode_do }}"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered"
                                                                    role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                                                onclick="closeHapus{{ $s->kode_do }}()"
                                                                                class="btn btn-secondary">Close</button>
                                                                            <a href="/hapusdatado/{{ $s->kode_do }}"
                                                                                type="submit"
                                                            ...
                                                            <script>
                                                                function openHapus{{ $s->kode_do }}() {
                                                                    $('#modalHapus{{ $s->kode_do }}').modal('toggle');
                                                                }

                                                                function closeHapus{{ $s->kode_do }}() {
                                                                    $('#modalHapus{{ $s->kode_do }}').modal('toggle');
                                                                    $('#modalHapus{{ $s->kode_do }}').modal('dispose');
                                                                    $('.modal-backdrop').remove();
                                                                }
                                                            </script>
                                                        </div>
